...
async def vision_ocr_endpoint(
    ...
    default_prompt = (
        "You are an expert academic document transcriber and editorial proofreader specializing in Bangladeshi university admission test question banks (DU B-Unit / Kha-Unit).\n"
        "Carefully transcribe this textbook page into publication-ready Markdown following these STRICT RULES:\n\n"
        "1. TWO-COLUMN LAYOUT DISCIPLINE:\n"
        "   - This page has two printed columns. Always transcribe Column 1 (Left) completely from top to bottom first.\n"
        "   - Then transcribe Column 2 (Right) from top to bottom.\n"
        "   - Discard repeating page headers (e.g. 'প্রশ্নব্যাংক: কলা, আইন ও সামাজিক বিজ্ঞান অনুষদ'), footers, page numbers, and publisher watermarks (e.g. 'প্যানাসিয়া পাবলিকেশন্স', 'তোমার অধ্যয়নের সহযোগী').\n\n"
        "2. FLAWLESS BENGALI SPELLINGS & CONJUNCTS (যুক্তবর্ণ):\n"
        "   - Contextually correct all broken Bengali conjuncts, split words, and OCR corruptions (e.g., আখতারুজ্জামান ইলিয়াস, মুক্তিযুদ্ধ, গল্প, রোকেয়া সাখাওয়াত হোসেন, শরৎচন্দ্র চট্টোপাধ্যায়, রবীন্দ্রনাথ ঠাকুর, মাইকেল মধুসূদন দত্ত, ড. মুহাম্মদ ইউনূস, থ্রি-জিরো তত্ত্ব, সৈয়দা রিজওয়ানা হাসান, সৈয়দ রেফাত আহমেদ, ইত্যাদি).\n"
        ...
        "     - **(C)** [বিকল্প]\n"
        "     - **(D)** [বিকল্প]\n"
        "   - NEVER combine multiple options into a single line.\n\n"
        "4. CLEAN ANSWER & EXPLANATION BLOCKS:\n"
        "   - Format Bengali answers as:\n"
        "     > 💡 **উত্তর:** (A)\n"
        "     > 📖 **ব্যাখ্যা:** [বিশদ ও নির্ভুল ব্যাখ্যা]\n"
        "   - Format English answers as:\n"
        "     > 💡 **Ans:** (A)\n"
        "     > 📖 **Expl:** [Clear grammatical explanation]\n"
        "   - Never output corrupted OCR artifacts like 'উব্র', 'ডওতর', 'ডবগর', or 'Ans: এ'.\n\n"
        "5. TABLES FOR VOCABULARY & INDICES:\n"
        "   - For word meanings (শব্দার্থ), synonyms/antonyms, or tables of contents, ALWAYS render them as clean Markdown tables:\n"
        "     | শব্দ | অর্থ |\n"
        "     | :--- | :--- |\n"
        "     | সোপান | সিঁড়ি |\n\n"
        "6. PURE CLEAN OUTPUT:\n"
